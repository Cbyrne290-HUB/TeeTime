...
const clubs = [
  ...
  {
    name: "Killarney Golf & Fishing Club",
    slug: "killarney",
    description: "Three stunning lakeside courses set against the backdrop of the MacGillycuddy's Reeks mountains in Kerry.",
    address: "Mahony's Point, Killarney, Co. Kerry",
    county: "Kerry",
    lat: 52.0530, lng: -9.5480,
    phone: "+353 64 663 1034",
    email: "reservations@killarney-golf.com",
    website: "https://www.killarney-golf.com",
    holes: 18, par: 72,
  },
  {
    name: "Waterville Golf Links",
    slug: "waterville",
    description: "One of the world's great links courses — remote, rugged and magnificent on the Wild Atlantic Way in Kerry.",
    address: "Waterville, Co. Kerry",
    county: "Kerry",
    lat: 51.8324, lng: -10.1569,
  ...
  {
    name: "Doonbeg Golf Club",
    slug: "doonbeg",
    description: "A breathtaking Greg Norman-designed links on the Clare coast, carved through natural sand dunes. Trump International.",
    address: "Doonbeg, Co. Clare",
    county: "Clare",
    lat: 52.7245, lng: -9.5278,
    phone: "+353 65 905 5246",
    email: "golf@doonbeggolfclub.com",
  ...
  },
  {
    ...
    slug: "royal-portrush",
    description: "Host of The Open Championship 2019 and 2025. The Dunluce Links is the jewel of Irish golf.",
    address: "Dunluce Road, Portrush, Co. Antrim",
    county: "Antrim",
    lat: 55.2044, lng: -6.6583,
  ...
  },
  {
    ...
    slug: "portstewart",
    description: "World-class links golf on the stunning Causeway Coast with panoramic views across the Atlantic.",
    address: "117 Strand Road, Portstewart, Co. Derry",
    county: "Derry",
    lat: 55.1893, lng: -6.7192,
    phone: "+44 28 7083 2015",
    email: "info@portstewartgc.co.uk",
  ...
  },
  {
    ...
    slug: "enniscrone",
    description: "One of Ireland's hidden gems — a classic links course on the shores of Killala Bay in Co. Sligo.",
    address: "Enniscrone, Co. Sligo",
    county: "Sligo",
    lat: 54.2127, lng: -9.0993,
    phone: "+353 96 36297",
    email: "enniscronegc@eircom.net",
    website: "https://www.enniscronegolf.com",
    holes: 18, par: 73,
  },
  {
    name: "Connemara Golf Links",
    slug: "connemara",
    description: "Wild and beautiful links golf on the Connemara coast — heather, mountains and the Atlantic as your backdrop.",
    address: "Ballyconneely, Clifden, Co. Galway",
    county: "Galway",
    lat: 53.3730, lng: -9.9820,
    phone: "+353 95 23502",
    email: "links@connemaralinks.com",
    website: "https://www.connemaralinks.com",
    holes: 18, par: 72,
  },
  {
    name: "Tralee Golf Club",
    slug: "tralee",
    description: "Designed by Arnold Palmer on the rugged Kerry coastline — described as the most beautiful golf course in the world.",
    address: "West Barrow, Ardfert, Co. Kerry",
    county: "Kerry",
    lat: 52.3615, lng: -9.8632,
    phone: "+353 66 713 6379",
    email: "info@traleegolfclub.com",
    website: "https://www.traleegolfclub.com",
    holes: 18, par: 71,
  },
  {
    name: "Galway Bay Golf Resort",
    slug: "galway-bay",
    description: "A beautiful parkland and links course with stunning views of Galway Bay — perfect for visitors to the west.",
    address: "Renville, Oranmore, Co. Galway",
    county: "Galway",
    lat: 53.2625, lng: -8.9343,
    phone: "+353 91 790500",
    email: "golf@galwaybaygolfresort.com",
