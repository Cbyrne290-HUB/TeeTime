  ...
  return (
    <div className="max-w-md mx-auto px-4 py-8">
      ...
      <p className="text-sm mb-6" style={{ color: "var(--text-muted)" }}>
        Define what you&apos;re looking to snipe — keyword, category, and the max you&apos;d pay.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <div>
            ...
            <input
              name="notes"
              placeholder="e.g. resells for €40–60, size M only"
              className="w-full px-3 py-2 rounded-lg text-sm border outline-none focus:border-purple-500"
              style={{ background: "var(--surface-2)", borderColor: "var(--border)", color: "var(--text)" }}
            />
          </div>
